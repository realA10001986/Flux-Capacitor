...
This repository holds the most current firmware for CircuitSetup's excellent [Flux Capacitor Light & Sound Control Board](https://circuitsetup.us/product-category/back-to-the-future-props/). The "Flux Capacitor" is key to time travel in the movies "Back to the Future".

The kit parts are available [here](https://circuitsetup.us/product-category/back-to-the-future-props/).

Here is my FC, built around this Control Board and the other parts of the kit (backing board, window kit):
